...
Begin DesktopWindow MattersWindow
   ...
   Begin DesktopButton B_FIles
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   "To see the files for an item, search for and highlight it on the list box and then press this button."
      Top             =   20
      Transparent     =   False
      Underline       =   False
      Visible         =   True
	...
	#tag Method, Flags = &h21
		Private Sub showFiles()
		  ...
		  If ListMembers.SelectedRowIndex >= 0 Then
		    ...
		    End If
		  Else
		    messagebox("Please selct a matter before searching for related files")
