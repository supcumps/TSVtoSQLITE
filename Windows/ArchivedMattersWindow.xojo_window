#tag DesktopWindow
Begin DesktopWindow ArchivedMattersWindow
   Backdrop        =   0
   ...
   Begin DesktopGroupBox GroupBox1
      ...
      Begin DesktopTextField No
         ...
         Width           =   82
      End
      Begin DesktopTextField ArchiveDate
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
         ...
         Width           =   89
      End
      Begin DesktopTextField ArchivedNo
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
      ...
      Begin DesktopTextField BoxNo
         ...
         Width           =   312
      End
      Begin DesktopTextField FileLocation
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
      ...
      Begin DesktopLabel L_Resp
         ...
         Width           =   82
      End
      Begin DesktopLabel L_FilkeLocation
         AllowAutoDeactivate=   True
         Bold            =   False
         Enabled         =   True
         FontName        =   "System"
      ...
      Begin DesktopLabel L_Client
         ...
         Width           =   82
      End
      Begin DesktopLabel L_ArchiveNo
         AllowAutoDeactivate=   True
         Bold            =   False
         Enabled         =   True
         FontName        =   "System"
         ...
         Width           =   82
      End
      Begin DesktopLabel L_ArchiveDate
         AllowAutoDeactivate=   True
         Bold            =   False
         Enabled         =   True
         FontName        =   "System"
      ...
      Begin DesktopLabel L_DocRemoved
         ...
         Width           =   82
      End
      Begin DesktopTextField DateOfDestruction
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  If dbFile.Exists Then
		    Try
		      rs = db.SelectSQL("SELECT * FROM Archives")
		      
		      // populate the listbox
		      Var columns As RowSet = db.TableColumns("Archives")
	...
	#tag Method, Flags = &h21
		Private Sub SearchForArchives()
		  listMembers.RemoveAllRows
		  Var rs As rowset
		  
		  
		  Var sql As String = "SELECT * FROM Archives "
		  
		  If SearchArchives.Text <> "" Then   // create the WHERE clause to isolate records matching the search field
